...
const HomeConten = ({ children }: { children: React.ReactNode }) => {
    return (
...
const Product = ({ image, tag, icon }: { image: string, tag?: string, icon?: React.ReactNode }) => {
    return (
...
const Description = ({ title, label }: { title: string, label: string }) => {
    return (
...
const Price = ({ col1, col2, col3, price }: { col1: string, col2: string, col3?: string, price: string }) => {
    return (
